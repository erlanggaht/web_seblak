  ...
  return (
    <>
     <section className='cards mx-10 py-14 '>
        <section className='text-center'>
          <h2 className='text-3xl text-neutral-700'>Get our food truck for your next event</h2>
    ...
    <section className='flex justify-center md:flex-nowrap flex-wrap gap-6 mt-10 sm:mt-16'>
      ...
      <section className='mt-10 sm:mt-40'>
        ...
        <Cards_flex props={{flex_reverse :"md:flex-row-reverse",btn_hidden:"hidden",img_class:"cf2"}}/>
        </section>
      </section>
    </>
  )
