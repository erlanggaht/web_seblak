...
export default function Footer() {
  return (
    <footer className='text-slate-900 mt-20 mb-0 pb-12 md:px-36 px-10 '>
        <section className='flex flex-wrap lg:flex-nowrap gap-20'>

        <section className='aboutUs w-full md:-1/2'>
            <h3 className='text-xl text-neutral-700 dark:text-white text-neutral-700 dark:text-white'>Tentang Kami</h3>
            ...
            <section>
                <h5 className='text-sm mt-5 sm:mt-8 text-neutral-700 dark:text-white'>Follow kami!</h5>
        ...
        <h3 className='text-xl text-neutral-700 dark:text-white'>Tautan</h3>
        ...
        <h3 className='text-xl text-neutral-700 dark:text-white'>Rating</h3>
        ...
        <h3 className='text-xl text-neutral-700 dark:text-white'>Hubungi Kami</h3>
        <Input_email/>
