...
export default function Cards({values}) {
  return (
    <>
     <section className={`${values.card_image} rounded-md bg-cover bg-no-repeat bg-center relative w-full sm:w-[400px] h-[400px] my-2 shadow-lg sm:shadow-sm scale-90 hover:scale-100 ease-in duration-500 cursor-text`}>
