...
export function Cards_flex ({props}) {
    return (
        ...
        <section className={`lg:flex ${props.flex_reverse} lg:justify-center lg:items-center lg:h-[400px]  flex flex-col-reverse`}>
            ...
            <h2 className='text-3xl text-neutral-700 text-left lg:text-left hidden sm:inline'>{props.title}</h2>
            ...
            <section className={`${props.btn_hidden}`}> <Button_order text={'PESAN'}/> </section>
